...
#create model:
model = RNN(weights_matrix=weights_matrix, hidden_size=450, num_layers=1, num_classes=3)
...
#         print(len(sample['label']))
        ...
        if i > 0 and i % 300 == 0:
            ...
            if val_acc > best_val_acc:
                ...
                torch.save(model.state_dict(), 'RNN450_best_model.pkl')
...
pkl.dump(OUT_DICT, open("SNL_RNN_HIDDEN450.p", "wb"))
