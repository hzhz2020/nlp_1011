...
class RNN(nn.Module):
    def __init__(self, weights_matrix, hidden_size, num_layers, num_classes):
        ...
        self.rnn1 = nn.GRU(emb_size, hidden_size, num_layers, batch_first=True, dropout=0, bidirectional=True)
        self.rnn2 = nn.GRU(emb_size, hidden_size, num_layers, batch_first=True, dropout=0, bidirectional=True)
