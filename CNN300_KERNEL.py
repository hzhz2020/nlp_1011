...
for kernel_size in kernel_size_list:     
    ### CNN:
    model = CNN_kernel(weights_matrix=weights_matrix, hidden_size=300, kernel_size= kernel_size, num_classes=3)
    learning_rate = 3e-4
        ...
        for i, sample in enumerate(train_loader):
            ...
            if i > 0 and i % 300 == 0:
                ...
                if val_acc > best_val_acc:
                    ...
                    model_name = 'CNN300_KERNEL' + str(kernel_size) + '_best_model.pkl' 
    ...
    OUT_DICT_NAME = 'SNL_CNN_HIDDEN300_KERNEL' + str(kernel_size) + '.p'
