...
### CNN:
model = CNN(weights_matrix=weights_matrix, hidden_size=300,  num_classes=3)
print(type(model))
learning_rate = 3e-4
    ...
    for i, sample in enumerate(train_loader):
        ...
        if i > 0 and i % 300 == 0:
            ...
            if val_acc > best_val_acc:
                ...
                torch.save(model.state_dict(), 'CNN300_best_model.pkl')
...
pkl.dump(OUT_DICT, open("SNL_CNN_HIDDEN300.p", "wb"))
